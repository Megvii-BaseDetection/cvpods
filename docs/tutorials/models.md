...
Models (and their sub-models) in cvpods are built by
...
cvpods recognizes models in pytorch's `.pth` format, as well as the `.pkl` files
in our model zoo.

You can use a model by just `outputs = model(inputs)`.
Next, we explain the inputs/outputs format used by the builtin models in cvpods.
...
The output of the default [DatasetMapper]( ../modules/data.html#cvpods.data.DatasetMapper) is a dict
...
* "instances": [Instances](../modules/structures.html#cvpods.structures.Instances)
  object with the following fields:
  * "pred_boxes": [Boxes](../modules/structures.html#cvpods.structures.Boxes) object storing N boxes, one for each detected instance.
...
* "proposals": [Instances](../modules/structures.html#cvpods.structures.Instances)
  object with the following fields:
  * "proposal_boxes": [Boxes](../modules/structures.html#cvpods.structures.Boxes)
