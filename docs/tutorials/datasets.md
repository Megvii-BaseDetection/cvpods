...
If you want to use a custom dataset while also reusing cvpods's data loaders,
you will need to

1. Register your dataset (i.e., tell cvpods how to obtain your dataset).
...
To let cvpods know how to obtain a dataset named "my_dataset", you will implement
...
from cvpods.data import DatasetCatalog
...
the [load_coco_json](../modules/data.html#cvpods.data.datasets.load_coco_json) function can be used.
...
Here is a list of metadata keys that are used by builtin features in cvpods.
...
NOTE: For background on the concept of "thing" and "stuff" categories, see
