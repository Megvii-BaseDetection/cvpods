...
latex_documents = [
    (master_doc, "cvpods.tex", "cvpods Documentation", "cvpods contributors", "manual")
]
...
def url_resolver(url):
    if ".html" not in url:
        url = url.replace("../", "")
        return "https://git-core.megvii-inc.com/zhubenjin/cvpods/tree/megvii" + url
    else:
        if DEPLOY:
            return "http://cvpods.readthedocs.io/" + url
        else:
            return "/" + url
